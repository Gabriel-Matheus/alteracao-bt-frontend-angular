...
@Component({
  selector: 'app-alteracao-bt',
  standalone: false,
  templateUrl: './alteracao-bt.component.html',
  styleUrl: './alteracao-bt.component.css'
})

export class AlteracaoBtComponent implements OnInit {
